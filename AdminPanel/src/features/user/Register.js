                ...
                <div className='py-24 px-10'>
                    ...
                    <form onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className="mb-4">
                            ...
                            <InputText defaultValue={registerObj.name} updateType="name" containerStyle="mt-4" labelTitle="Имя" updateFormValue={updateFormValue}/>

                            <InputText defaultValue={registerObj.emailId} updateType="emailId" containerStyle="mt-4" labelTitle="Почта" updateFormValue={updateFormValue}/>
                        ...
                        <div className='text-center mt-4'>Уже есть аккаунт? <Link to="/login"><span className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Войти</span></Link></div>
                    </form>
                </div>
            </div>
            </div>
